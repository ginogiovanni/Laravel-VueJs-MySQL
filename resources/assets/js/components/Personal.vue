            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="mostrarForm('personal','registrar')" class="btn btn-secondary">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="personal in arrayPersonal" :key="personal.id">
                                    <td>
                                        <button type="button" @click="mostrarForm('personal','modificar',personal)" class="btn btn-warning btn-sm">
                                    ...
                                    <td v-text="personal.rut"></td>
                                    <td v-text="personal.nombre"></td>
                                    <td v-text="personal.fecha_nac"></td>
                                    <td v-text="personal.edad"></td>
                                    <td v-text="personal.direccion"></td>
                                    <td v-text="personal.nombre_comuna"></td>                                    
                                    <td v-text="personal.telefono"></td>
                                    <td v-text="personal.correo"></td>
                                    <td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="modificarPersonal()">Modificar</button>
                            </div>
                        </div>
                    </div>
                    </template>
    ...
    export default {
        ...
        methods : {
            ...
            desactivarPersonal(id){
                ...
                title: '¿Estás seguro de desactivar el personal seleccionado?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    .then(function (response) {
                        ...
                        swalWithBootstrapButtons(
                        'Desactivado!',
                        'El personal seleccionado se desactivó con éxito.',
                        'success'
                        )
                    })
                    .catch(function (error) {
            ...
            activarPersonal(id){
                ...
                swalWithBootstrapButtons({
                title: '¿Estas seguro de activar el personal seleccionado?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Aceptar',
                cancelButtonText: 'Cancelar',
                ...
                if (result.value) {
                    ...
                    .then(function (response) {
                        ...
                        swalWithBootstrapButtons(
                        'Activado!',
                        'El personal seleccionado se activo con exito.',
                        'success'
                        )
                    })
                    .catch(function (error) {
            ...
            validarPersonal(){
                ...
                if (!this.nombre) {
                    this.errorMostrarMsjPersonal.push("El campo nombre no puede estar vacío");
                }

                if (!this.direccion) {
                    this.errorMostrarMsjPersonal.push("El campo dirección no puede estar vacío");
                }
                if (!this.rut) {
                    this.errorMostrarMsjPersonal.push("El campo rut no puede estar vacío");
                }

                if(this.idcomuna == 0){
                     this.errorMostrarMsjPersonal.push("Debe seleccionar una comuna");
                }
                if(this.idregion == 0){
                     this.errorMostrarMsjPersonal.push("Debe seleccionar una región");
                }
                if(this.idprovincia == 0){
                     this.errorMostrarMsjPersonal.push("Debe seleccionar una provincia");
                }

                if (this.errorMostrarMsjPersonal.length) {
