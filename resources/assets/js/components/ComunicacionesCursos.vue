            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Comunicaciones Cursos
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="comunicaciones in arrayComunicacion" :key="comunicaciones.id">
                                    ...
                                    <td v-text="comunicaciones.nombre +' '+ comunicaciones.descripcion"></td>
    ...
    export default {
        ...
        methods : {
            listarComunicacion(page, buscar, criterio){
                let me = this;
                var url = '/comunicacionescursos?page='+page+'&buscar='+buscar+'&criterio='+criterio;
            ...
            modificarComunicacion(){
                ...
                axios.put('/comunicacionescursos/modificar', {
                    'titulo': this.titulo,                    
            ...
            desactivarComunicacion(id){
                ...
                if (result.value) {
                    ...
                    axios.put('/comunicacionescursos/desactivar', {
                        'id': id
                    })
                    .then(function (response) {
                        me.listarComunicacion(1, '', 'nombre');                        
            ...
            activarComunicacion(id){
                ...
                if (result.value) {
                    ...
                    axios.put('/comunicacionescursos/activar', {
                        'id': id
                    })
                    .then(function (response) {
                        me.listarComunicacion(1, '', 'nombre');                        
